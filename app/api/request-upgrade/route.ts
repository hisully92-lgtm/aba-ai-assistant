...
export async function POST(req: NextRequest) {
  const { companyId, companyName, currentPlan, requestedPlan, resourceType, contactEmail, contactName } = await req.json();
