...
const PLANS = [
  {
    ...
    features: ["Up to 2 clinicians", "Up to 10 clients", "1 location", "Basic data collection", "Session notes", "Progress reports", "Parent portal", "Visual analytics + graphs", "Email support", "HIPAA BAA included"],
    highlight: false,
    cta: "Select Starter",
  },
  {
    ...
    features: ["Up to 3 clinicians", "Up to 25 clients", "1 location", "All data collection tools", "AI session notes", "Parent portal", "Visual analytics + graphs", "Priority support", "HIPAA BAA included"],
    highlight: false,
    cta: "Select Basic",
  },
  {
